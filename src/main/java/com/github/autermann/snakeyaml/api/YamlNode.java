...
public interface YamlNode {
    ...
    /**
     * Abstract {@link Visitor} implementation to allow smaller implementations.
     * Per default implementations will delegate to one of
     * <ul>
    ...
    /**
     * Abstract {@link ReturningVisitor} implementation to allow smaller
