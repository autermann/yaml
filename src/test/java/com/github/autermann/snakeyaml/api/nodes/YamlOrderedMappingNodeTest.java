...
public class YamlOrderedMappingNodeTest {
    ...
    public void testType() {
        YamlNode node = factory.orderedMappingNode();
        ...
        errors.checkThat(node, is((mappingNode())));
        errors.checkThat(node, is(not(nullNode())));
        errors.checkThat(node, is(not(numberNode())));
        errors.checkThat(node, is((orderedMappingNode())));
